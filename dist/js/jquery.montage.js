...
(function( window, $, undefined ) {
	...
	*/
	...
	$.fn.imagesLoaded 			= function( callback ) {
		var $images = this.find('banner_images'),
			len 	= $images.length,
			_this 	= this,
	...
	$.Montage.prototype 		= {
		...
		_updatePrevImage	: function( $nextimg ) {
			var $prevImage 		= this.element.find('banner_images.montage:last');
		...
		_create 			: function( options ) {
			...
			instance.$imgs		= instance.element.find('banner_images');
		...
		add					: function( $images, callback ) {
			...
			var $images_stripped	= $images.find('banner_images');
		...
		_add				: function( $images, callback ) {
			var instance	= this;
			$images.find('banner_images').each( function(i) {
				instance._insertImage( $(this) );
			});
